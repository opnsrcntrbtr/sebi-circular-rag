...
|---|---|---|
| Corpus | `data/corpus/circulars.jsonl` (scraped + ingested locally) | [`opnsrcntrbtrian/sebi-circulars`](https://huggingface.co/datasets/opnsrcntrbtrian/sebi-circulars) HF dataset, `chunks` config (83,752 section-aware chunks, 1,490 circulars incl. all 130 SEBI master circulars, chunker_version `2026-09-03-toc-long-title-merge`) |
