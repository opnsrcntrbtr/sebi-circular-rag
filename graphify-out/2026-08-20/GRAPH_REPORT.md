...
### Community 89 - "main"
Cohesion: 0.36
Nodes (7): call(), main(), _norm(), Does answering a golden_v7 row require a circular the corpus does not hold?  Spe, Returns (answer, reasoning). The judge is a reasoning model: the oMLX API     se, Uppercase, strip all whitespace — so 'CIR/MIRSD/5/ 2013' matches     'CIR/MIRSD/, windows()
