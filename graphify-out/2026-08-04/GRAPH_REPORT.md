...
## Summary
- 2034 nodes · 4363 edges · 129 communities (107 shown, 22 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 262 edges (avg confidence: 0.57)
- Token cost: 11,904 input · 1,521 output
...
### Community 7 - "LLM Grounding and Judging"
Cohesion: 0.09
...
### Community 72 - "Evaluation Gate Floors"
Cohesion: 0.18
...
### Community 78 - "CI Gate Verification"
Cohesion: 0.20
...
### Community 82 - "Threshold and Scoring"
Cohesion: 0.28
...
### Community 99 - "Re-pooled Row Labeling"
Cohesion: 0.43
...
### Community 115 - "Item Loading Utilities"
Cohesion: 1.00
...
- **Why does `Chunk` connect `LLM Grounding and Judging` to `Benchmarking and Indexing`, `Web UI and Demo`, `Chunking and Embedding`, `Benchmark Dataset Generation`, `Hybrid Retrieval Indexing`, `Contextual Header Generation`, `SPLADE Sparse Retrieval`, `RAG Pipeline API`, `Hugging Face Pipeline`, `Reranker Evaluation Harness`, `Faithfulness and Abstention`, `Supersession Reranking Logic`, `Lexical Reranking and Pooling`, `Golden Dataset Validation`, `HyDE Query Expansion`, `Query Lexical Expansion`, `Qwen MLX Reranker`, `Prompt Injection Detection`, `Span to Chunk Resolution`, `Benchmark Artifact Export`, `Benchmark Export Testing`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `RAGPipeline` connect `RAG Pipeline API` to `Benchmarking and Indexing`, `Chunking and Embedding`, `LLM Grounding and Judging`, `Benchmark Dataset Generation`, `Hybrid Retrieval Indexing`, `Document Lineage Tracking`, `Temporal Evaluation Runner`, `API Integration Testing`, `Hugging Face Pipeline`, `Reranker Evaluation Harness`, `Supersession Reranking Logic`, `Lexical Reranking and Pooling`, `Evaluation Metrics Reporting`, `Evaluation Harness Testing`, `Supersession Precision Measurement`, `TREC Run Parsing`, `Retrieval Metric Evaluation`, `MRR Evaluation`, `Parsing Latency Measurement`, `Retrieval Recall Evaluation`, `Temporal Accuracy Evaluation`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `build_regulatory_index()` connect `Regulatory Basis Indexing` to `RAG Pipeline API`, `Regulation Lineage Resolution`?**
